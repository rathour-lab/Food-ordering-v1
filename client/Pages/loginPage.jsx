...
/>
          ...
          <div className="relative z-10 space-y-3 pointer-events-none bg-black/20 p-4 rounded-xl backdrop-blur-xs">
            <h1 className="text-3xl font-extrabold leading-tight">
              Interactive Dining <br />Delivered to Your Dimension.
            </h1>
           <p className="text-gray-100 text-base font-light leading-relaxed">
  Order your favorite pizzas and delicious meals in minutes.
  Freshly prepared, hot, and delivered straight to your doorstep.
</p>
          </div>
        </div>
